...
public abstract class HslColor : RgbColor
{
    public HslColor(string hex) : base(hex) => RgbToHls(R, G, B);

    public double H => RgbToHls(R, G, B).h;
    public double S => RgbToHls(R, G, B).s;
    public double L => RgbToHls(R, G, B).l;
